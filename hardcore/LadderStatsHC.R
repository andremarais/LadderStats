...
urlB <- "http://eu.battle.net/d3/en/rankings/era/1/rift-hardcore-barbarian"
urlC <- "http://eu.battle.net/d3/en/rankings/era/1/rift-hardcore-crusader"
urlDH <- "http://eu.battle.net/d3/en/rankings/era/1/rift-hardcore-dh"
urlM <- "http://eu.battle.net/d3/en/rankings/era/1/rift-hardcore-monk"
urlWD <- "http://eu.battle.net/d3/en/rankings/era/1/rift-hardcore-wd"
urlW <- "http://eu.battle.net/d3/en/rankings/era/1/rift-hardcore-wizard"
...
for (i in 1:999){
    ...
    b <- herospellsHC(profilenames[i,1],HeroIDsHC(profilenames[i,1], colnames(profilenames)[1])[1])
    c <- herospellsHC(profilenames[i,2],HeroIDsHC(profilenames[i,2], colnames(profilenames)[2])[1])
    dh <- herospellsHC(profilenames[i,3],HeroIDsHC(profilenames[i,3], colnames(profilenames)[3])[1])
    m <- herospellsHC(profilenames[i,4],HeroIDsHC(profilenames[i,4], colnames(profilenames)[4])[1])
    wd <- herospellsHC(profilenames[i,5],HeroIDsHC(profilenames[i,5], colnames(profilenames)[5])[1])
    w <- herospellsHC(profilenames[i,6],HeroIDsHC(profilenames[i,6], colnames(profilenames)[6])[[1]])
...
write.csv(cspells, file = "crusaderHC.csv")
...
write.csv(dhspells, file = "dhHC.csv")
...
write.csv(mspells, file = "monkHC.csv")
...
write.csv(wdspells, file = "wdHC.csv")
...
write.csv(wspells, file = "wizardHC.csv")
